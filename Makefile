...
notebooks:
	...
	$(BIN)/python -m jupyter nbconvert --to notebook --execute --inplace --ExecutePreprocessor.kernel_name=arena-lab --ExecutePreprocessor.timeout=3600 notebooks/04_la_cadena_que_no_se_corta.ipynb
